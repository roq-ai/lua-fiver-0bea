...
import { getBlocklyScriptById } from 'apiSdk/blockly-scripts';
...
function BlocklyScriptViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Blockly Script Detail View
          </Text>
          {hasAccess('blockly_script', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/blockly-scripts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
